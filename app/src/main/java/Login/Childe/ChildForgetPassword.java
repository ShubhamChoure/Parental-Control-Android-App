...
public class ChildForgetPassword extends AppCompatActivity {
    EditText mailETxt;
    Button submitBtn;
    Button lottiebtn;
    FirebaseAuth mAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_child_forget_password);
        init();
                ...
                if(TextUtils.isEmpty(mailETxt.getText().toString()))
                {
                    ...
                    mAuth.sendPasswordResetEmail(mailETxt.getText().toString().trim()).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            ...
                            mailSentAnime = new LottieDialog(ChildForgetPassword.this).setAnimation(R.raw.mailsent).setAutoPlayAnimation(true).setAnimationRepeatCount(0).addActionButton(lottiebtn).setTitle("Mail Sent").setMessage("Please check your In-Box");
                            mailSentAnime.show();
                            mailDialog.dismiss();
                        }
    ...
    void init()
    {
        ...
        mailDialog = new LottieDialog(ChildForgetPassword.this);
        lottiebtn = new Button(ChildForgetPassword.this);
    }
}